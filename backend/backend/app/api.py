...
import random
import json
from app.NeraulNetwork.unit import *
import torch

from app.NeraulNetwork.model import NeuralNet
...
with open('./app/intents.json', 'r') as json_data:
...
async def answer_question(question: dict) -> dict:
    ...
    if prob.item() > 0.75:
        ...
        ans = {
            "id" : ids+1,
            "question" : f"{bot_name}: I don't understanding..."
        }
        return {
            "data" : "Success"
            }
